...
# Tạo DataFrame riêng cho Raw, thêm partition time để sau này dễ query
raw_df = final_df \
...
es_config_base = {
    ...
    "es.write.operation": "upsert",  # Kích hoạt chế độ cập nhật
    "es.mapping.id": "id"            # Nói cho Spark biết: "Hãy lấy cột 'id' làm khóa chính"
}

# Định nghĩa ánh xạ topic và index (1-1 với Kafka topic)
topics_indices = {
